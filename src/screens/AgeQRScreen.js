            ...
            <View style={styles.container}>
                <View style={styles.Rcontainer}>
                    <View style = {styles.title}>
                        <Text style={{fontSize:17}}>QR코드를 인식해 다음을 확인하세요.</Text>
                    </View>
                    <View style={styles.contantContainer}>
                        <Image style = {styles.profile} source={require(`../../profile.jpg`)}/>
                        <View style={styles.textContainer}><Text style = {styles.content}>{"생년월일\n"}{this.state.idnumber_front}</Text></View>
                    </View>
                    <Text>{"\n"}</Text>
                    <QRCode
                    content={"{info: "+this.state.idnumber_front+"API_KEY: API_ID: code:"+this.state.code}
                    size={200}
                    bgColor='white'
                    fgColor='black'
                    />
